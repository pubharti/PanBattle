					...
					<div class="inner-payment">
					    <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="section-headline text-center">
                                <h3>ROOM ID : 54896</h3>
                                <p>Please Provide Room id to Your Friend to join Room </p>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="card-list">
                                ...
                                <br>
                                <div class ="players">
                                <label class ="player1">Player1</label>
                                <label class ="player2">Player2</label>
                                 <label class ="player3">Player3</label>
                                 <label class ="player4">Player4</label>

                                <div>
                                	<button type="button" class="btn btn-success btn-lg btn-block" disabled>Enroll Team</button><br>
